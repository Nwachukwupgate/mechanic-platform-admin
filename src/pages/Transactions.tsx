      ...
      <AdminTable>
        ...
        <tbody>
          {data?.items?.map((t: any) => (
            <tr key={t.id}>
              <AdminTd><AdminLink to={`/transactions/${t.id}`}>{t.type.replace(/_/g, ' ')}</AdminLink></AdminTd>
              ...
              <AdminTd>{t.bookingId ? <AdminLink to={`/bookings/${t.bookingId}`}>View</AdminLink> : null}</AdminTd>
