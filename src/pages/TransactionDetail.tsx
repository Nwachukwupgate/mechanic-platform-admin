...
export default function AdminTransactionDetail() {
  ...
  return (
    <>
      <AdminPageHeader backTo="/transactions" title={tx.type.replace(/_/g, ' ')} subtitle={tx.reference} />
      <AdminSection title="Summary">
        ...
        {tx.bookingId ? <p className="text-sm mt-1"><AdminLink to={`/bookings/${tx.bookingId}`}>Open booking</AdminLink></p> : null}
